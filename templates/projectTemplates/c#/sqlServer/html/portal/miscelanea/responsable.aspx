<%@ Page Language="C#" MasterPageFile="~/portal/master/masterWeb.Master" AutoEventWireup="true"
    Codebehind="responsable.aspx.cs" Inherits="juleweb.portal.miscelanea.responsable"
    Title="Página sin título" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p class="mensaje">
        <strong>Comienza contenido principal</strong>
        </p>
    <div id="parteCentral">
        ...
        <p>
            ...
            de Car&aacute;cter Personal y disposiciones complementarias.
        </p>
        <br />
        <p>
            ...
            facilitado a esta empresa, en los t&eacute;rminos y condiciones recogidos en las
            <a href="condiciones.aspx">CONDICIONES DE USO </a>, y a adoptar las medidas necesarias
            para evitar su alteraci&oacute;n, p&eacute;rdida y tratamiento o acceso no autorizado,
            de acuerdo con lo establecido en el Reglamento de medidas de seguridad de los ficheros
            automatizados que contienen datos de car&aacute;cter personal, conforme a lo dispuesto
            en el Real Decreto 994/1999, de 11 de junio, con el fin de que ning&uacute;n tercero
            no autorizado acceda a los datos personales de los usuarios de Micasoft.</p>
